...
extern "C" void kMain(void) {
    ...
    uint32_t* ptr = (uint32_t*)vbe->physical_base_pointer;
    ...
    memset((void*)(vbe->physical_base_pointer), 0xFF12121212, vbe->x_resolution * vbe->y_resolution * ((vbe->bits_per_pixel+1) / 8));
